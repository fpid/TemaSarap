	...
	<header class="entry-header page-header">
		<h3 class="entry-title"><a href="{$id|link:comments_link}">{$subject|tag:the_title}</a></h3>
			<div class="entry-meta">
				...
				<span class="byline"><i class="fa fa-user"></i><span class="author vcard"><a class="url fn n" href="https://plus.google.com/u/0/114538365656725310775/posts" rel="publisher" title="{$author}"> {$author}</a></span></span>
				...
				<span class="view-count"><i class="fa fa-eye "></i><a title="{$views}x dilihat">{$views}x</a></span>{/if}
			</div><!-- .entry-meta -->
	</header>
